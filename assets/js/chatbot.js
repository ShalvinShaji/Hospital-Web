...
$('.chat-input__form').on('submit', function (e) {
  ...
  $('.chat-logs').append('<div id="cm-msg-0" class="chat-msg background-warning push-left bot"><div class="cm-msg-text">' + msg + '</div><span class="msg-avatar"><img class="chat-box-overlay_robot" src="./assets/img/chatbot/user.png" ></span></div>');  
